            ...
            <View style={styles.sheet}>
                ...
                >
                    <Text style={styles.intro}>
                        Sofia Go е приложение за градска мобилност в София, което комбинира градски транспорт, паркиране, паркинг зони, карта и полезни функции за придвижване в града. Тази страница описва какви данни използва приложението, с каква цел и как се обработват.
                    </Text>
