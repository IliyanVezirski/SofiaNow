    ...
    const handleScheduleSms = async () => {
        ...
        try {
            ...
            if (!result.exactAlarmGranted) {
                Alert.alert(
                    'SMS е планиран',
                    `Ще изпратим SMS ${scheduleLabel}. За максимална точност разреши точни аларми.`,
                    [
            ...
            Alert.alert('SMS е планиран', `Ще изпратим SMS ${scheduleLabel}.`);
        } catch (error) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>Избери кола и провери зоната, след което ще изпратим SMS.</Text>
            ...
            >
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        <Text style={styles.sectionTitle}>Запазена кола</Text>
                    ...
                    {cars.length === 0 ? (
                        <View style={styles.emptyCard}>
                            ...
                            <Text style={styles.emptyText}>Първо добави номер в Моите коли, за да можем да изпратим SMS.</Text>
                ...
                <View style={styles.summaryCard}>
                    ...
                    <Text style={styles.summaryMeta}>{`Кола: ${selectedCarLabel}`}</Text>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    >
                        <View style={styles.scheduleToggleBody}>
                            <Text style={styles.scheduleToggleTitle}>Изпрати по-късно</Text>
                            <Text style={styles.scheduleToggleText}>{scheduleExpanded ? 'Задай час за автоматично изпращане.' : `Планиран час: ${scheduledTimeInput}`}</Text>
                        </View>
                    ...
                    {scheduleExpanded ? (
                        <View style={styles.schedulePanel}>
                            ...
                            >
                                ...
                                <Text style={styles.secondaryActionText}>{scheduling ? 'Планира...' : 'Планирай изпращане'}</Text>
                            </TouchableOpacity>
                        </View>
                    ) : null}
                </View>
